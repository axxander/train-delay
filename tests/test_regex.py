...
class TestRegex(unittest.TestCase):
	...
	def test_interface(self):
		...
		# need to capture invalid station IDs
		user_input = r"yrkk shf 0800 2020-10-09"
		self.assertEqual(re.search(Constants.interface_pattern, user_input).groups(), ("rkk", "shf", "0800", "2020-10-09"))
